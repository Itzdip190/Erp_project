    ...
    <div class="top-header-bar">
        <div class="container d-flex flex-wrap justify-content-between align-items-center">
            ...
            <div class="d-none d-sm-flex align-items-center gap-3">
                <a href="tel:+919219441716"><i class="fas fa-phone-alt me-1"></i> +91 92194 41716</a>
                <span>|</span>
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-3">
                    ...
                    <p class="text-slate-400 mb-2" style="color: #94a3b8;"><i class="fas fa-phone-alt text-primary me-2"></i> +91 92194 41716</p>
