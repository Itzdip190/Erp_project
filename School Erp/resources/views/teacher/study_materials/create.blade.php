...
<head>
    ...
    <title>Upload Study Material — Teacher Portal</title>
...
<body>
    <div class="sidebar">
        ...
        <a href="{{ route('teacher.study-materials.index') }}" style="color:#fff;text-decoration:none;padding:10px;display:block;font-weight:600;"><i class="fas fa-arrow-left me-2"></i> Back to Materials</a>
    </div>
    <div class="main">
        <h2 style="font-family:'Plus Jakarta Sans';font-size:22px;font-weight:800;margin-bottom:6px;">Upload Study Material</h2>
        <p style="color:#6b7280;font-size:13px;margin-bottom:20px;">Only your allocated classes, sections, and subjects are available for study material sharing.</p>
        ...
        <div class="card">
            <form action="{{ route('teacher.study-materials.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" placeholder="e.g. Unit 3 Physics Lecture Notes PDF" required>
                </div>

                <div class="form-group">
                    <label class="form-label">Description / Summary</label>
                    <textarea name="description" class="form-control" rows="4" placeholder="Enter topic summary or reading notes..."></textarea>
                </div>

                <div class="form-group">
                    <label class="form-label">Upload Document File (PDF, PPT, Word, Zip - Max 20MB)</label>
                    <input type="file" name="attachment" class="form-control" required>
                </div>

                <div style="margin-top:24px;">
                    <button type="submit" class="btn btn-blue"><i class="fas fa-upload"></i> Share Resource with Class Students</button>
                </div>
            </form>
        </div>
    </div>
