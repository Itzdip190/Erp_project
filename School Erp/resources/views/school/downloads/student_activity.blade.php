...
<div class="dl-module">
    ...
    <div class="card dl-card-filter">
        <div class="card-body dl-filter-body">
            <form method="GET" action="{{ route('school.downloads.student-activity') }}" style="display:flex; justify-content:space-between; align-items:flex-end; gap:20px; flex-wrap:wrap;">
                <div style="display:flex; gap:20px; flex-grow:1; flex-wrap:wrap;">
                    ...
                    <div class="form-group" style="margin-bottom:0; flex:2; min-width:180px;">
                        <label class="dl-form-label">Search Student</label>
                        <input type="text" name="search" class="form-control dl-input" placeholder="Student Name/Student ID..." value="{{ $search }}">
                    </div>
                </div>
                ...
                <div style="display:flex; gap:10px;">
                    ...
                    <button type="button" class="dl-btn dl-btn-outline" onclick="dlExportCSV('studentActTable', 'Student_Activity_Logs.csv')">
    ...
    <div class="dl-table-card">
        ...
        <div style="overflow-x:auto;">
            <table class="dl-table" id="studentActTable">
                <thead>
                    <tr>
                ...
                <tbody>
                    @forelse($paginatedActivities as $index => $act)
                        <tr>
                            ...
                            <td>
                                <span class="badge dl-badge-blue">{{ $act['admission_id'] }}</span>
                            </td>
                            <td>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" style="text-align:center; padding:50px; color:#64748b;">
                                ...
                                No student activity log entries found.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
