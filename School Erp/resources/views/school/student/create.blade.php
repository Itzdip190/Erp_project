...
<div class="page-hdr">
    <div class="page-hdr-left">
        ...
        <p>Admit a new student and record complete personal, academic, family, transport, bank and medical health details</p>
    </div>
                        ...
                        <div style="flex: 1;">
                            <div class="grid-3">
                                <div class="form-group">
                                    <label class="form-label">Admission ID (Roll/Sequence) <span>*</span></label>
                                    <input type="text" class="form-control" value="Auto-generated upon save" disabled>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="grid-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="first_name_local" class="form-control" value="{{ old('first_name_local') }}">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Last Name Local</label>
                                    <input type="text" name="last_name_local" class="form-control" value="{{ old('last_name_local') }}">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="grid-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="house_role" class="form-control" value="{{ old('house_role') }}" placeholder="e.g. Captain">
                                </div>
                                <div class="form-group">
                ...
                <div class="accordion-body">
                    ...
                    <div class="grid-4" style="margin-bottom:20px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="father_alternate_phone" class="form-control" value="{{ old('father_alternate_phone') }}">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="grid-4" style="margin-bottom:20px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="father_id" class="form-control" value="{{ old('father_id') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Father's Aadhaar Number</label>
                            <input type="text" name="father_aadhar" class="form-control" value="{{ old('father_aadhar') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Father's Income</label>
                            <input type="text" name="father_income" class="form-control" value="{{ old('father_income') }}">
                        </div>
                    </div>
                    <div class="grid-3" style="margin-bottom:25px;">
                        <div class="form-group">
                            <label class="form-label">Father Qualification</label>
                            <input type="text" name="father_qualification" class="form-control" value="{{ old('father_qualification') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Father Passport Number</label>
                            <input type="text" name="father_passport" class="form-control" value="{{ old('father_passport') }}">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="grid-4" style="margin-bottom:20px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mother_alternate_phone" class="form-control" value="{{ old('mother_alternate_phone') }}">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="grid-4" style="margin-bottom:20px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mother_id" class="form-control" value="{{ old('mother_id') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Mother's Aadhaar Number</label>
                            <input type="text" name="mother_aadhar" class="form-control" value="{{ old('mother_aadhar') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Mother's Income</label>
                            <input type="text" name="mother_income" class="form-control" value="{{ old('mother_income') }}">
                        </div>
                    </div>
                    <div class="grid-3" style="margin-bottom:25px;">
                        <div class="form-group">
                            <label class="form-label">Mother Qualification</label>
                            <input type="text" name="mother_qualification" class="form-control" value="{{ old('mother_qualification') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Mother Passport Number</label>
                            <input type="text" name="mother_passport" class="form-control" value="{{ old('mother_passport') }}">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="grid-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="family_id" class="form-control" value="{{ old('family_id') }}">
                        </div>
                        <div class="form-group">
                ...
                <div class="accordion-body">
                    ...
                    <div class="grid-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="city" id="current_city" class="form-control" value="{{ old('city') }}" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">State <span>*</span></label>
                            <input type="text" name="state" id="current_state" class="form-control" value="{{ old('state') }}" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Country</label>
                            <input type="text" name="country" id="current_country" class="form-control" value="{{ old('country', 'India') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Pin Code <span>*</span></label>
                            <input type="text" name="pincode" id="current_pincode" class="form-control" value="{{ old('pincode') }}" required>
                        </div>
                    </div>
                    <div class="grid-3" style="margin-bottom:30px;">
                        <div class="form-group">
                            <label class="form-label">Region</label>
                            <input type="text" name="region" id="current_region" class="form-control" value="{{ old('region') }}">
                        </div>
                    </div>
                    ...
                    <div class="grid-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="permanent_address" id="perm_address" class="form-control" value="{{ old('permanent_address') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Address Line 2</label>
                            <input type="text" name="permanent_address_line_2" id="perm_address_line_2" class="form-control" value="{{ old('permanent_address_line_2') }}">
                        </div>
                    </div>
                    <div class="grid-4">
                        <div class="form-group">
                            <label class="form-label">City</label>
                            <input type="text" name="permanent_city" id="perm_city" class="form-control" value="{{ old('permanent_city') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">State</label>
                            <input type="text" name="permanent_state" id="perm_state" class="form-control" value="{{ old('permanent_state') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Country</label>
                            <input type="text" name="permanent_country" id="perm_country" class="form-control" value="{{ old('permanent_country') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Pin Code</label>
                            <input type="text" name="permanent_pincode" id="perm_pincode" class="form-control" value="{{ old('permanent_pincode') }}">
                        </div>
                    </div>
                    <div class="grid-3">
                        <div class="form-group">
                            <label class="form-label">Region</label>
                            <input type="text" name="permanent_region" id="perm_region" class="form-control" value="{{ old('permanent_region') }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="accordion-body">
                    ...
                    <div class="grid-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bank_micr" class="form-control" value="{{ old('bank_micr') }}">
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="accordion-body">
                    <div class="grid-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="medical_height" class="form-control" value="{{ old('medical_height') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Weight (kg)</label>
                            <input type="text" name="medical_weight" class="form-control" value="{{ old('medical_weight') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Vision (Left)</label>
                            <input type="text" name="medical_vision_left" class="form-control" value="{{ old('medical_vision_left') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Vision (Right)</label>
                            <input type="text" name="medical_vision_right" class="form-control" value="{{ old('medical_vision_right') }}">
                        </div>
                    </div>
                    <div class="grid-2">
                        <div class="form-group">
                            <label class="form-label">Dental Condition</label>
                            <input type="text" name="medical_dental" class="form-control" value="{{ old('medical_dental') }}">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="grid-3">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="medical_disabilities" class="form-control" rows="2">{{ old('medical_disabilities') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="grid-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="medical_doctor_name" class="form-control" value="{{ old('medical_doctor_name') }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Doctor's Phone Number</label>
                            <input type="text" name="medical_doctor_phone" class="form-control" value="{{ old('medical_doctor_phone') }}">
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    // Trigger age calculation initially if date of birth is already filled
