                        ...
                        <div style="flex: 1;">
                            ...
                            <div class="grid-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="national_id_input" name="national_id" class="form-control" value="{{ old('national_id', $student->national_id) }}" maxlength="12" oninput="this.value = this.value.replace(/[^0-9]/g, '')" placeholder="12-digit Aadhaar number">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="birthmark" class="form-control" value="{{ old('birthmark', $student->birthmark) }}">
                                </div>
                            </div>
                            <div class="grid-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="sub_category" class="form-control">
                                        ...
                                        <option value="EWS" {{ old('sub_category', $student->sub_category) === 'EWS' ? 'selected' : '' }}>EWS</option>
                                        <option value="Others" {{ old('sub_category', $student->sub_category) === 'Others' ? 'selected' : '' }}>Others</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">RTE Student?</label>
                                    <select name="is_rte" class="form-control">
                                        <option value="0" {{ old('is_rte', $student->is_rte) == 0 ? 'selected' : '' }}>No</option>
                                        <option value="1" {{ old('is_rte', $student->is_rte) == 1 ? 'selected' : '' }}>Yes</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <select name="religion" class="form-control">
                                ...
                                <option value="Sikhism" {{ old('religion', $student->religion) === 'Sikhism' ? 'selected' : '' }}>Sikhism</option>
                                <option value="Buddhism" {{ old('religion', $student->religion) === 'Buddhism' ? 'selected' : '' }}>Buddhism</option>
                                <option value="Jainism" {{ old('religion', $student->religion) === 'Jainism' ? 'selected' : '' }}>Jainism</option>
                                <option value="Zoroastrianism" {{ old('religion', $student->religion) === 'Zoroastrianism' ? 'selected' : '' }}>Zoroastrianism (Parsi)</option>
                ...
                <div class="accordion-body">
                    ...
                    <div class="grid-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="house_number" id="current_house_number" class="form-control" value="{{ old('house_number', $student->house_number) }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Location</label>
                            <input type="text" name="location" id="current_location" class="form-control" value="{{ old('location', $student->location) }}">
                        </div>
                    </div>
                    <div class="grid-4">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="transport_route" class="form-control">
                                    ...
                                    @foreach($routes as $route)
                                        <option value="{{ $route->name }}" {{ old('transport_route', $student->transport_route) === $route->name ? 'selected' : '' }}>{{ $route->name }}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <select name="transport_vehicle_code" class="form-control">
                                    ...
                                    @foreach($vehicles as $vehicle)
                                        <option value="{{ $vehicle->vehicle_no }}" {{ old('transport_vehicle_code', $student->transport_vehicle_code) === $vehicle->vehicle_no ? 'selected' : '' }}>{{ $vehicle->vehicle_no }} ({{ $vehicle->driver_name }})</option>
                                    @endforeach
                                </select>transport_vehicle_code) }}">
                            </div>
                            <div class="form-group">
                                ...
                                <select name="transport_stop" class="form-control">
                                    ...
                                    @foreach($stops as $stop)
                                        <option value="{{ $stop->name }}" {{ old('transport_stop', $student->transport_stop) === $stop->name ? 'selected' : '' }}>{{ $stop->name }} (₹{{ $stop->fare }})</option>
                                    @endforeach
                                </select>transport_stop) }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid-3">
                            <div class="form-group">
                                ...
                                <select name="transport_drop_vehicle_code" class="form-control">
                                    ...
                                    @foreach($vehicles as $vehicle)
                                        <option value="{{ $vehicle->vehicle_no }}" {{ old('transport_drop_vehicle_code', $student->transport_drop_vehicle_code) === $vehicle->vehicle_no ? 'selected' : '' }}>{{ $vehicle->vehicle_no }} ({{ $vehicle->driver_name }})</option>
                                    @endforeach
                                </select>transport_drop_vehicle_code) }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-body">
                    <div class="grid-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="emergency_name" class="form-control" value="{{ old('emergency_name', $student->emergency_name) }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Emergency Contact Number</label>
                            <input type="text" name="emergency_number" class="form-control" value="{{ old('emergency_number', $student->emergency_number) }}">
                        </div>
                        <div class="form-group">
                ...
                <div class="accordion-body">
                    ...
                    <div class="grid-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="pen_number_input" name="pen_number" class="form-control" value="{{ old('pen_number', $student->pen_number) }}" maxlength="11" oninput="this.value = this.value.replace(/[^0-9]/g, '')" placeholder="11-digit PEN number">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Apaar ID</label>
                            <input type="text" id="apaar_id_input" name="apaar_id" class="form-control" value="{{ old('apaar_id', $student->apaar_id) }}" maxlength="11" oninput="this.value = this.value.replace(/[^0-9]/g, '')" placeholder="11-digit Apaar ID">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="grid-3" style="margin-top:16px;">
                        <div class="form-group" style="display: flex; align-items: center; gap: 8px; margin-top: 28px;">
                                <input type="checkbox" id="new_admission_tick" name="is_new_admission" value="1" {{ (old('is_new_admission', $student->admission_type === 'New Admission' ? 1 : 0)) ? 'checked' : '' }} style="width: 18px; height: 18px; accent-color: var(--gold); cursor: pointer;">
                        ...
                        <div class="form-group">
                            ...
                            <select name="boarding_type" class="form-control">
                                ...
                                <option value="Day Scholar" {{ old('boarding_type', $student->boarding_type) === 'Day Scholar' ? 'selected' : '' }}>Day Scholar</option>
                                <option value="Hosteler" {{ old('boarding_type', $student->boarding_type) === 'Hosteler' ? 'selected' : '' }}>Hosteler</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Defence Personal? (Yes/No)</label>
                            <select name="defence_personal" class="form-control">
                                <option value="0" {{ old('defence_personal', $student->defence_personal) == '0' ? 'selected' : '' }}>No</option>
                                <option value="1" {{ old('defence_personal', $student->defence_personal) == '1' ? 'selected' : '' }}>Yes</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid-4">
                        ...
                        <div class="form-group">
                            ...
                            <select name="any_allergy" class="form-control">
                                <option value="0" {{ old('any_allergy', $student->any_allergy) == '0' ? 'selected' : '' }}>No</option>
                                <option value="1" {{ old('any_allergy', $student->any_allergy) == '1' ? 'selected' : '' }}>Yes</option>
                            </select>
                        </div>
                        <div class="form-group">
