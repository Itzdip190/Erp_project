...
<div class="glass-card">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        <h2 style="font-family: 'Syne', sans-serif;">Modify Student Profile</h2>
    ...
    <form action="{{ route('school.students.update', $student->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="display: flex; gap: 2rem; margin-bottom: 2rem; flex-wrap: wrap;">
            ...
            <div style="display: flex; flex-direction: column; align-items: center; gap: 1rem; min-width: 150px;">
                <div id="avatarPreview" style="width: 120px; height: 120px; border-radius: 50%; border: 2px dashed var(--border); display: flex; align-items: center; justify-content: center; background-image: url('{{ $student->photo_url }}'); background-position: center; background-size: cover; overflow: hidden; color: var(--text-muted);">
                    @if(!$student->photo)
            ...
            <div style="flex: 1; display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem;">
                <div>
                    ...
                    <input type="text" name="first_name" class="form-input" value="{{ old('first_name', $student->first_name) }}" required>
                </div>
                <div>
                    ...
                    <input type="text" name="last_name" class="form-input" value="{{ old('last_name', $student->last_name) }}" required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="blood_group" class="form-input" value="{{ old('blood_group', $student->blood_group) }}" placeholder="e.g. O+">
                </div>
                <div>
                    ...
                    <input type="text" name="religion" class="form-input" value="{{ old('religion', $student->religion) }}">
                </div>
                <div>
                    ...
                    <input type="text" name="caste" class="form-input" value="{{ old('caste', $student->caste) }}">
                </div>
                <div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
            ...
            <div>
                ...
                <input type="email" name="guardian_email" class="form-input" value="{{ old('guardian_email', $student->guardian_email) }}">
            </div>
            <div>
        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr 1fr 1fr; gap: 1.5rem; margin-bottom: 2rem;">
            <div style="grid-column: span 2;">
                ...
                <input type="text" name="address" class="form-input" value="{{ old('address', $student->address) }}" required>
            </div>
            <div>
                ...
                <input type="text" name="city" class="form-input" value="{{ old('city', $student->city) }}" required>
            </div>
            <div>
                ...
                <input type="text" name="state" class="form-input" value="{{ old('state', $student->state) }}" required>
            </div>
            <div>
                ...
                <input type="text" name="pincode" class="form-input" value="{{ old('pincode', $student->pincode) }}" required>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem; margin-bottom: 3rem;">
            ...
            <div>
                ...
                <input type="date" name="admission_date" class="form-input" value="{{ old('admission_date', $student->admission_date->format('Y-m-d')) }}" required>
            </div>
            <div>
                ...
                <input type="text" name="roll_number" class="form-input" value="{{ old('roll_number', $student->roll_number) }}">
            </div>
            <div>
                ...
                <input type="number" step="0.01" name="opening_due_balance" class="form-input" value="{{ old('opening_due_balance', $student->opening_due_balance) }}">
            </div>
        </div>
