...
<body>
    <div class="print-page-container">
        @foreach($incomes as $index => $income)
            <div class="invoice-card">
                ...
                <div class="header-row">
                    <div style="display: flex; align-items: center; gap: 12px;">
                        ...
                        @else
                            <div style="width: 36px; height: 36px; border-radius: 6px; background: #ecfdf5; color: var(--primary); display: flex; align-items: center; justify-content: center; font-size: 18px; border: 1px solid var(--border-color);">
                ...
                <table class="invoice-table">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div style="font-weight: 700; font-size: 11px; margin-bottom: 2px;">{{ $income->title }}</div>
                                <div style="color: var(--text-muted); font-size: 10px;">{{ $income->description ?: 'Payment received' }}</div>
                            </td>
                            <td style="text-align: right; font-weight: 700; font-size: 11px;">₹{{ number_format($income->amount, 2) }}</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="amount-words">
                    Amount in Words: <span>{{ $income->amount_in_words }}</span>
                </div>
            ...
            @if(($index + 1) % $pageBreakInterval === 0 && ($index + 1) < count($incomes))
