...
@section('title', 'Manage Income Vouchers DateWise')
...
<div class="inc-container">
    <div class="inc-hdr-row">
        <h2 class="inc-title">Manage Vouchers DateWise</h2>
        <div style="display: flex; gap: 8px;">
            <button class="inc-btn-outline" style="border-color: var(--inc-green-mid); color: var(--inc-green-dark); font-weight: 700; height: 38px; display: inline-flex; align-items: center; gap: 6px; border-radius: 8px;" onclick="openPrintAllConfig('voucher')">
    ...
    <div class="inc-filter-card">
        <form method="GET" action="{{ route('school.income.vouchers.datewise') }}" class="inc-filter-form" id="filterForm">
            ...
            <div class="filter-group">
                ...
                <select class="filter-control" name="income_head_id">
            ...
            <button type="submit" class="inc-btn-go">Go <i class="fas fa-arrow-right"></i></button>
        </form>
    </div>
                    ...
                    <tr id="row-{{ $v->id }}" @if($v->deleted_at) style="opacity: 0.65; background-color: #f1f5f9;" @endif>
                        ...
                        <td style="text-align: center;">
                            @if(!$v->deleted_at)
                                ...
                                <button class="act-icon print" onclick="openPrintModal('{{ route('school.income.vouchers.invoice', $v->id) }}')" title="Print Receipt/Voucher">
    ...
    <div class="inc-modal" style="max-width: 550px;">
        ...
        <div class="inc-modal-body">
            <table class="inc-table" style="border: 1px solid var(--inc-border);">
                ...
                <tr id="detDocRow">
                    <td style="font-weight: 700; background: var(--inc-gray);">Attachment:</td>
    ...
    <div class="inc-modal" style="max-width: 450px;">
        ...
        <div class="inc-modal-body" style="padding: 20px;">
            ...
            <div class="modal-footer" style="margin-top:20px; display:flex; justify-content:flex-end; gap:10px;">
                <button type="button" class="inc-btn-outline" style="padding: 8px 16px; font-weight:700; border-radius:8px; border: 1.5px solid var(--inc-border); cursor:pointer;" onclick="closePrintAllModal()">Cancel</button>
                <button type="button" class="inc-btn-submit" style="padding: 8px 16px; font-weight:700; border-radius:8px; width:auto; border: 1px solid var(--inc-green);" onclick="submitPrintAll()">
