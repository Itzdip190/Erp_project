...
/* ─── SIDEBAR ─────────────────────────────────────────────── */
.sidebar{
    width:175px;min-width:175px;background:var(--navy);
...
/* ─── MAIN ────────────────────────────────────────────────── */
.main{margin-left:175px;flex:1;display:flex;flex-direction:column;min-height:100vh;}
...
@media(max-width:768px){
    .sidebar{transform:translateX(-175px);width:175px;}
