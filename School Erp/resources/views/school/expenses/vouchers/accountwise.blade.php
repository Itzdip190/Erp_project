...
@section('title', 'Manage Vouchers AccountWise')
...
<div class="exp-container">
    <div class="exp-hdr-row">
        <h2 class="exp-title">Manage Vouchers AccountWise</h2>
    ...
    <div class="exp-filter-card">
        <form method="GET" action="{{ route('school.expenses.vouchers.accountwise') }}" class="exp-filter-form" id="filterForm">
            <div class="filter-group">
                <label>Select Expense Head</label>
                <select class="filter-control" name="expense_head_id" id="headSelector" onchange="submitIfSelected()">
            ...
            <div class="filter-group">
                ...
                <select class="filter-control" disabled>
                    @foreach($expenseHeads as $head)
                        @if((string)$expenseHeadId === (string)$head->id)
            ...
            <div class="filter-group">
                <label>Status</label>
                <select class="filter-control" name="payment_status" style="min-width: 100px;">
            ...
            <div class="filter-group">
                ...
                <select class="filter-control" name="approval_status" style="min-width: 100px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="11" style="text-align: center; color: var(--exp-text2); padding: 40px;">
                                No vouchers found for this Expense Head.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
...
{{-- ADD VOUCHER MODAL (Pre-select head if active) --}}
...
function submitIfSelected() {
    const val = document.getElementById('headSelector').value;
    if (val) {
        document.getElementById('filterForm').submit();
    } else {
        // Clear filter context and reload empty dropdown view
        location.href = '{{ route("school.expenses.vouchers.accountwise") }}';
    }
}
...
// Share all preloaded vouchers with frontend safely
