...
/* ── STAFF EDIT DARK MODE OVERRIDES ── */
body.dark-mode {
...
body.dark-mode #cameraModal button {
    color: #cbd5e1 !important;
}
...
<div class="st-card" style="max-width: 1100px; margin: 0 auto;">
    <div class="st-card-hdr" style="display: flex; justify-content: space-between; align-items: center;">
        <h3 style="margin: 0;">Edit Staff Profile: {{ $staff->full_name }}</h3>
        <a href="{{ route('school.staff.download-pdf', $staff->id) }}" class="btn" style="background-color: var(--st-blue, #1d4ed8); color: #fff; border: 1px solid #fff; display: inline-flex; align-items: center; gap: 6px; padding: 6px 14px; border-radius: 6px; font-weight: 600; text-decoration: none; font-size: 13px;">
                ...
                <div class="st-section-body">
                    ...
                    <div class="st-grid-4">
                        ...
                        <div class="st-form-group">
                            ...
                            <select name="additional_fields[religion]" class="st-control">
                                ...
                                <option value="Hinduism" {{ old('additional_fields.religion', $staff->additional_fields['religion'] ?? '') === 'Hinduism' ? 'selected' : '' }}>Hinduism</option>
                                <option value="Islam" {{ old('additional_fields.religion', $staff->additional_fields['religion'] ?? '') === 'Islam' ? 'selected' : '' }}>Islam</option>
                                <option value="Christianity" {{ old('additional_fields.religion', $staff->additional_fields['religion'] ?? '') === 'Christianity' ? 'selected' : '' }}>Christianity</option>
                                <option value="Sikhism" {{ old('additional_fields.religion', $staff->additional_fields['religion'] ?? '') === 'Sikhism' ? 'selected' : '' }}>Sikhism</option>
                                <option value="Buddhism" {{ old('additional_fields.religion', $staff->additional_fields['religion'] ?? '') === 'Buddhism' ? 'selected' : '' }}>Buddhism</option>
                                <option value="Jainism" {{ old('additional_fields.religion', $staff->additional_fields['religion'] ?? '') === 'Jainism' ? 'selected' : '' }}>Jainism</option>
                                <option value="Zoroastrianism" {{ old('additional_fields.religion', $staff->additional_fields['religion'] ?? '') === 'Zoroastrianism' ? 'selected' : '' }}>Zoroastrianism (Parsi)</option>
                                <option value="Judaism" {{ old('additional_fields.religion', $staff->additional_fields['religion'] ?? '') === 'Judaism' ? 'selected' : '' }}>Judaism</option>
                                <option value="Others" {{ old('additional_fields.religion', $staff->additional_fields['religion'] ?? '') === 'Others' ? 'selected' : '' }}>Others</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="st-grid-4">
                        ...
                        <div class="st-form-group">
                            ...
                            <input type="text" name="pan_number" class="st-control" value="{{ old('pan_number', $staff->pan_number) }}">
                        </div>
                        <div class="st-form-group">
                            <label class="st-label">Aadhar Number</label>
                            <input type="text" name="additional_fields[aadhar_number]" class="st-control" value="{{ old('additional_fields.aadhar_number', $staff->additional_fields['aadhar_number'] ?? '') }}">
                        </div>
                        <div class="st-form-group" style="grid-column: span 2; display: flex; align-items: center; gap: 15px; margin-bottom: 0;">
                            <div id="avatarPreview" style="width: 80px; height: 80px; border-radius: 50%; border: 2px dashed var(--st-border); display: flex; align-items: center; justify-content: center; background-position: center; background-size: cover; overflow: hidden; background-color: #f8fafc; flex-shrink: 0; border-color: var(--border); background-image: url('{{ $staff->photo_url }}');">
                                @if(!$staff->photo)
