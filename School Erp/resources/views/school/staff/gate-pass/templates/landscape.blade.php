{{-- LANDSCAPE DUAL-COPY STAFF GATE PASS TEMPLATE (School Copy + Security / Staff Copy) --}}
@php
        ...
        <div>
            <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:8px; border-bottom:1.5px solid #2563eb; padding-bottom:6px;">
                ...
                <div style="text-align:right;">
                    ...
                    <div style="font-size:10px; font-weight:700; color:#475569; margin-top:2px;">#<span id="pv-ref-no-land1">{{ $autoNumber ?? '2026/SGP/1' }}</span></div>
                </div>
            </div>
            ...
            <table style="width:100%; border-collapse:collapse; font-size:11.5px; margin-bottom:12px;">
                <tr style="height:22px;">
                    <td style="width:100px; color:#64748b; font-weight:600;">Staff Name:</td>
                    <td><strong id="pv-staff-name-land1" style="color:#0f172a;">{{ $staff->full_name }}</strong></td>
                </tr>
                <tr style="height:22px;">
                    <td style="color:#64748b; font-weight:600;">Emp ID / Dept:</td>
                    <td id="pv-emp-dept-land1" style="color:#0f172a; font-weight:600;">{{ $staff->employee_id }} ({{ optional($staff->department)->name ?? 'General' }})</td>
                </tr>
                <tr style="height:22px;">
                    <td style="color:#64748b; font-weight:600;">Designation:</td>
                    <td><strong id="pv-designation-land1" style="color:#0f172a;">{{ optional($staff->designation)->name ?? 'Staff' }}</strong></td>
                </tr>
                <tr style="height:22px;">
                    <td style="color:#64748b; font-weight:600;">Reason:</td>
                    <td><span id="pv-reason-land1" style="background:#dbeafe; color:#1e40af; padding:1px 6px; border-radius:3px; font-weight:600; font-size:11px;">Official Duty</span></td>
                </tr>
            </table>
        ...
        <div>
            <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:8px; border-bottom:1.5px solid #10b981; padding-bottom:6px;">
                ...
                <div style="text-align:right;">
                    ...
                    <div style="font-size:10px; font-weight:700; color:#475569; margin-top:2px;">#<span id="pv-ref-no-land2">{{ $autoNumber ?? '2026/SGP/1' }}</span></div>
                </div>
            </div>
            ...
            <table style="width:100%; border-collapse:collapse; font-size:11.5px; margin-bottom:12px;">
                <tr style="height:22px;">
                    <td style="width:100px; color:#64748b; font-weight:600;">Staff Name:</td>
                    <td><strong id="pv-student-name-land2" style="color:#0f172a;">{{ $staff->full_name }}</strong></td>
                </tr>
                <tr style="height:22px;">
                    <td style="color:#64748b; font-weight:600;">Emp ID / Dept:</td>
                    <td id="pv-class-sec-land2" style="color:#0f172a; font-weight:600;">{{ $staff->employee_id }} ({{ optional($staff->department)->name ?? 'General' }})</td>
                </tr>
                <tr style="height:22px;">
                    <td style="color:#64748b; font-weight:600;">Designation:</td>
                    <td><strong id="pv-guardian-name-land2" style="color:#0f172a;">{{ optional($staff->designation)->name ?? 'Staff' }}</strong></td>
                </tr>
                <tr style="height:22px;">
                    <td style="color:#64748b; font-weight:600;">Reason:</td>
                    <td><span id="pv-reason-land2" style="background:#d1fae5; color:#065f46; padding:1px 6px; border-radius:3px; font-weight:600; font-size:11px;">Official Duty</span></td>
                </tr>
            </table>
