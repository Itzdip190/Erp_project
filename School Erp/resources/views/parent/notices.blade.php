...
<head>
    ...
    <title>Notice Board — SchoolCloud ERP</title>
...
.notice-box{
    ...
    background:var(--page); margin-bottom:15px; display:flex; flex-direction:column; gap:10px;
    transition:transform .2s, box-shadow .2s;
}
.notice-box:hover{transform:translateY(-1px); box-shadow:var(--shadow);}
.notice-hdr{display:flex; justify-content:space-between; align-items:flex-start;}
.notice-title{font-size:15px; font-weight:750; color:var(--navy); font-family:'Plus Jakarta Sans',sans-serif;}
...
<div class="main">
    ...
    <div class="pg">
        <div class="card">
            <div class="card-hdr">
                <span class="card-title"><i class="fas fa-bullhorn" style="color:var(--gold);margin-right:8px;"></i>Important Circulars & Announcements</span>
            </div>
            <div class="card-body">
